-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'MANAGER', 'STAFF', 'ACCOUNTANT', 'HR', 'SALES');
...
-- CreateEnum
CREATE TYPE "TransactionType" AS ENUM ('INVOICE_PAYMENT', 'PURCHASE_PAYMENT', 'EXPENSE', 'INCOME', 'JOURNAL_ENTRY', 'BANK_TRANSFER');
...
-- AddForeignKey
ALTER TABLE "FiscalYear" ADD CONSTRAINT "FiscalYear_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
